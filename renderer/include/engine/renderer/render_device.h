...
/// Presents the completed frame through the active backend, which owns
/// the swapchain: the bgfx backend advances its frame (applying vsync and
/// drawable-size changes). No-op before initialization.
