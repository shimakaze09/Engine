...
/// Mesh-domain alias for core::NothrowBuffer, the allocate/assign contract
/// runtime's animation payload loader shares.
template <typename T>
...
/// copy a compile error (review follow-up to — the former
