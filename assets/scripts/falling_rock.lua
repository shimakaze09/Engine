...
-- Releases this rock's state so a reused entity slot starts fresh. Fires
-- on editor Stop, engine.new_scene, and engine.load_scene alike (#198):
-- the VM persists across a scene transition (Lua globals are the
