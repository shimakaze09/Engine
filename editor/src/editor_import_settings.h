...
// selected asset's .cookmeta is read and parsed once per selection, or
...
struct ImportSettingsDocument final {
  enum class State : std::uint8_t {
    Missing,    // no <asset>.cookmeta beside the asset
...
/// Returns the sidecar document for `<assetPath>.cookmeta`, reading the
