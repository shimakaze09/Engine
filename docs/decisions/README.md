...
to it. A record's decision text is never rewritten; the one edit allowed in
place is a **Status** line or an inline supersession note saying where the
code or a later record has moved past it.
...
| [0002](0002-macos-is-a-test-lane.md) | macOS is a build and headless-test lane (editor and shipping clauses superseded by 0015) | 2026-08-09 |
...
| [0015](0015-commercial-anime-engine-on-six-platforms.md) | The product is a commercial anime-game engine: three editor platforms, six shipping targets | 2026-09-21 |
