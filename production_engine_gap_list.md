...
- `§0-7-d-i` `scripting/src/scripting.cpp` remains a 5K+ line global-state owner for Lua state, debugger/profiler state, entity script modules, player controllers, and persistent game state. **[critical]** `[~]`
